...
This repository contains samples apps for the Workspace ONE Intelligence SDK across iOS and Android.

For detailed information about the Workspace ONE IntelligenceSDK SDK and managing internal apps, see the [Omnissa Developer Portal SDKs](https://developer.omnissa.com/sdks/) page and navigate to the appropriate area.
...
The SDK is provided as either a [Package](https://github.com/euc-releases/ws1-intelligencesdk-sdk-ios/blob/master/Package.swift) or [Release](https://github.com/euc-releases/ws1-intelligencesdk-sdk-ios/releases). Please download the software from the appropriate location.
...
This software may also utilize Third-Pary Open Source Software as detailed on the [Open Source Notices](https://www.omnissa.com/open-source-notices/) page.
